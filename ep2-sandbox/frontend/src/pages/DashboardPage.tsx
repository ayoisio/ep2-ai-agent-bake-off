...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div
      className="relative flex min-h-auto flex-col bg-red overflow-x-hidden"
    ...
    >
      <div className="flex h-full grow flex-col">
        ...
        <div className="gap-4 px-6 flex flex-1 justify-center py-6">
          ...
          {/* Sidebar - Pass current user info */}
          <Sidebar
            firebaseUser={currentUser}
            mockUserId={userId || "user-002"}
          />
          ...
          <div className="flex flex-col max-w-[960px] flex-1">
            ...
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <p className="text-foreground tracking-light text-[24px] font-semibold leading-tight min-w-72">
                Recent Transactions
              </p>
            </div>
                ...
                <table className="flex-1">
                  <thead>
                    <tr className="bg-background">
                      ...
                      <th className="px-4 py-3 text-left text-foreground w-[350px] text-sm font-medium leading-normal">
                        Description
                      </th>
                    ...
                    {currentTransactions.map((transaction) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td
                            className={`h-[72px] px-4 py-2 w-[150px] text-sm font-normal leading-normal ${

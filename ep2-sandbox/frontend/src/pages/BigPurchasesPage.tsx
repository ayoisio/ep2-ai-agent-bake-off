  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      sender: "agent",
      text: "Welcome! I'm your Big Purchase Advisor. I can help you plan for major purchases like homes, cars, appliances, and other significant investments. I'll analyze your financial situation and provide personalized recommendations. What big purchase are you considering?",
      timestamp: new Date(),
    },
  ]);
    ...
    <div className="container mx-auto py-6 px-4 max-w-6xl">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-foreground">
          Big Purchase Advisor
        </h1>
        <p className="text-muted-foreground mt-2">
          Plan and prepare for major purchases with personalized financial
          guidance
        </p>
      </div>
            ...
            <div className="p-4 border-t">
              <div className="flex space-x-2">
                <Input
                  ...
                  placeholder="Ask about home buying, cars, or other big purchases..."
                  disabled={isLoading}
                />
                <Button

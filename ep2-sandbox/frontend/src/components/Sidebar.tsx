...
const Sidebar: React.FC<SidebarProps> = ({ firebaseUser, mockUserId }) => {
      ...
      const loadData = async () => {
        try {
          const [investmentsData, debtsData, userData] = await Promise.all([
            fetchInvestments(mockUserId),
            fetchDebts(mockUserId),
            fetchUser(mockUserId),
          ]);
  ...
  // Get initials from Firebase user or fallback to mock user
  const getInitials = () => {
  ...
  const getProfilePicture = () => {
    ...
    if (user?.profile_picture) return `/users/${user.profile_picture}`;
    return null;
  };
    ...
    <div className="flex flex-col w-80">
        ...
        <Card className="overflow-hidden border-border bg-card shadow-none">
          <CardContent>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              {user?.age && (
                <div className="text-center">
                  <p className="text-xl font-bold text-card-foreground capitalize">
                    {user.age}
                  </p>
                  <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">
                    Current Age
      ...
      {investments.slice(0, 5).map((account) => (
        <div
          ...
          className="flex items-center gap-4 bg-card px-4 min-h-[72px] py-2 justify-between mb-2 rounded-lg border border-border"
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-card-foreground text-base font-medium leading-normal line-clamp-1">
                {account.description}
              </p>
          ...
          <div className="shrink-0">
            <p className="text-card-foreground text-sm font-normal leading-normal">
              $
      ...
      {investments.length > 5 && (
        <button className="text-primary hover:text-primary/80 transition-colors mt-2 px-4">
          View More
        </button>
      )}
      ...
      {debts.slice(0, 5).map((account) => (
        ...
        >
          <div className="flex items-center gap-4">
            <div className="text-muted-foreground flex items-center justify-center rounded-lg bg-accent shrink-0 size-12">
              ...
              <svg
                ...
                viewBox="0 0 256 256"
              >
                <path d="M224,88H160V48a16,16,0,0,0-16-16H48A16,16,0,0,0,32,48V160H72a16,16,0,0,1,16,16v48a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V104A16,16,0,0,0,224,88ZM88,176a8,8,0,0,1-8,8H48V48H144V88a8,8,0,0,0,8,8h40v72H104A16,16,0,0,0,88,176Zm128,32H104v-8h88a8,8,0,0,0,0-16H104v-8h88a8,8,0,0,0,0-16H104v-8h88a8,8,0,0,0,0-16H104v-8h88a8,8,0,0,0,8-8V104h24Z"></path>
              </svg>
            </div>
            <div className="flex flex-col justify-center">
              <p className="text-card-foreground text-base font-medium leading-normal line-clamp-1">
          ...
          <div className="shrink-0">
            <p className="text-destructive text-sm font-normal leading-normal">
              $
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4 bg-card px-4 min-h-14 justify-between rounded-lg border border-border hover:bg-accent/50 transition-colors">
          <div className="flex items-center gap-4">
            ...
            <p className="text-card-foreground text-base font-normal leading-normal flex-1 truncate">
              Transfer
            </p>
          </div>
          <div className="shrink-0">
